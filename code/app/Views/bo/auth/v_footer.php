...
<!-- Footer -->
<div class="navbar navbar-sm navbar-footer border-top" style="position: fixed; bottom:0px; width:100%;">
    <div class="container-fluid">
        <span>&copy; <?= date('Y'); ?> <a href="<?= base_url(''); ?>"><?= $this->model->getSetting(1)->content; ?></a></span>
    </div>
