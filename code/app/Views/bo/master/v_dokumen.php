                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="d-inline-flex">
                                                        ...
                                                        <a href="#" class="dropdown-item sweet_warning_custom" data-url="<?= site_url('master/dokumenDelete/' . $row->id); ?>" data-bs-popup="popover" data-bs-trigger="hover" data-bs-content="Hapus Dokumen">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <object data="<?php echo site_url('master/dokumenShow?id=' . $row->id); ?>" type="application/pdf" width="100%" height="550px">
                                    <p>Unable to display PDF file. <a href="<?php echo site_url('master/dokumenShow?id=' . $row->id); ?>">Download</a> instead.</p>
                                </object>
                            </div>
                        </div>
