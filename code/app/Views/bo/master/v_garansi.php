                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="d-inline-flex">
                                                        ...
                                                        <a href="#" class="dropdown-item sweet_warning_custom" data-url="<?= site_url('master/garansiDelete/' . $row->id_sertifikat_garansi); ?>" data-bs-popup="popover" data-bs-trigger="hover" data-bs-content="Hapus Data">
...
<div id="modal_tambah" class="modal fade" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= site_url('master/garansiAdd'); ?>" method="post">
                <?= csrf_field(); ?>
        ...
        <div id="modal_edit_<?= $row->id_sertifikat_garansi; ?>" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="<?= site_url('master/garansiEdit'); ?>" method="post">
                        <?= csrf_field(); ?>
                        <input type="hidden" name="id_sertifikat_garansi" value="<?= $row->id_sertifikat_garansi; ?>">
                        <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control select-search" id="kategori_barang" name="kategori_barang" required>
                                        <option>Pilih Kategori Barang</option>
                                        <?php foreach ($dt_kategori as $kategori) {
                                            if ($row->kategori_barang == $kategori->id_kategori_barang) { ?>
                                                <option value="<?= $kategori->id_kategori_barang; ?>" selected><?= $kategori->nama; ?></option>
                                            <?php } else { ?>
                                                <option value="<?= $kategori->id_kategori_barang; ?>"><?= $kategori->nama; ?></option>
                                        <?php }
                                        } ?>
