    ...
    <div id="element" style="font-size: 12px;">
        ...
        <page_header>
            ...
            <div class="container">
                ...
                <div class="centered" style="margin-left: 499px; margin-top: -33px;"><b><?php echo $row_isiSurat->qrgen; ?></b></div>
            </div>
        </page_header>
        ...
        <div class="pagesetup">
            <div class="card-body" style="margin-left: -3px;">
                ...
                <table>
                    <tr>
                        <td style="text-align: justify;">Dengan hormat, <br> Sehubungan dengan kegiatan pekerjaan <?php echo $row_isiSurat->nama_paket_pekerjaan; ?> menggunakan proses belanja dengan metode pembelian E-Catalogue/ EPURCHASING <i style="color: blue;">(https://e-katalog.lkpp.go.id/)</i>, dengan ID Paket : <?php echo $row_isiSurat->id_paket; ?>, tanggal paket dibuat : <?php setlocale(LC_ALL, 'IND');
                                                                                                                                                                                                                                                                                                                                                                                                echo strftime('%d %B %Y', strtotime($row_isiSurat->tanggal_paket_dibuat)); ?>, sesuai dengan pekerjaan yang sudah dikerjakan serta dikirim : </td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <table style="width: 74%; margin-left: 20px;">
                ...
                <tr>
                    ...
                    <td style="width: 100%; text-align: justify;">
                        <?php echo $row_isiSurat->nama_ppk; ?> - <?php echo $row_isiSurat->satuan_kerja; ?> - <?php echo $row_isiSurat->alamat_pengiriman; ?> - <?php echo $row_isiSurat->no_tlp_ppk; ?>
                    </td>
                </tr>
            </table>
            <br>
            ...
            <div class="card-body" style="margin-left: -3px;">
                <table>
                    <tr>
                        ...
                        ?>
                        <td style="font-size: 13px;"><?php echo ($row_isiSurat->sphp); ?><?php setlocale(LC_ALL, 'IND');
                                                                                            echo strftime('%d', strtotime($row_isiSurat->tgl_sphp)); ?>/<?php echo $bln; ?>/<?php setlocale(LC_ALL, 'IND');
                ...
                <table style="width: 75%; margin-left: 20px;">
                    <tr>
                        <td>Nomor Pesanan/SP</td>
                        <td>:</td>
                        <td style="text-align: justify; width: 100%;"><?php echo $row_isiSurat->no_spk; ?>, Tanggal : <?php setlocale(LC_ALL, 'IND');
                                                                                                                        echo strftime('%d %B %Y', strtotime($row_isiSurat->tanggal_mulai_spk)); ?>
                        </td>
                    </tr>
                    <tr>
                        <td>Pekerjaan</td>
                        <td>:</td>
                        <td style="width: 100%; text-align: justify;"><?php echo $row_isiSurat->nama_paket_pekerjaan; ?></td>
                    </tr>
                    <tr>
                        <td>Nilai Kontrak </td>
                        <td>:</td>
        ...
        <div class="pagesetup">
            <table class="center" border="0" style="margin-left: 252px;">
                ...
                <tr>
                    ...
                    ?>
                    <td style="font-size: 13px;"><?php echo ($row_isiSurat->sg); ?><?php setlocale(LC_ALL, 'IND');
                                                                                    echo strftime('%d', strtotime($row_isiSurat->tgl_sg)); ?>/<?php echo $bln; ?>/<?php setlocale(LC_ALL, 'IND');
            ...
            <table>
                <tr>
                    <td>Dengan ini menyatakan bahwa kami memberikan Sertifikat Garansi atas barang / jasa yang kami serahkan untuk pekerjaan <?php echo $row_isiSurat->nama_paket_pekerjaan; ?>, sesuai dengan nomor SP : <?php echo $row_isiSurat->no_spk; ?> tanggal : <?php setlocale(LC_ALL, 'IND');
                                                                                                                                                                                                                                                                            echo strftime('%d %B %Y', strtotime($row_isiSurat->tanggal_mulai_spk)); ?>, nomor paket E-Katalog : <?php echo $row_isiSurat->id_paket; ?>
                        tanggal <?php setlocale(LC_ALL, 'IND');
                                echo strftime('%d %B %Y', strtotime($row_isiSurat->tanggal_paket_dibuat)); ?>, Tahun Anggaran <?php echo $row_isiSurat->tahun_anggaran; ?>, yang dilaksanankan oleh <?php echo $model->getSetting(9)->content; ?> :
                    </td>
                </tr>
            </table>
        </div>
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td style="width: 100%; text-align: left; font-size: 12px;">
                        ...
                        <?php
                        foreach ($dt_garansi as $garansi) {
                            if ($row_surat['kategori_barang'] == $garansi->id_sertifikat_garansi) {
                                echo " $garansi->isi_sertifikat";
                            }
                        }
                        ?>
            ...
            <div class="card-body" style="margin-left: -3px;">
                <table>
                    <tr>
                        ...
                        ?>
                        <td style="font-size: 13px;"><?php echo ($row_isiSurat->sppp); ?><?php setlocale(LC_ALL, 'IND');
                                                                                            echo strftime('%d', strtotime($row_isiSurat->tgl_sppp)); ?>/<?php echo $bln; ?>/<?php setlocale(LC_ALL, 'IND');
    ...
    <div id="element" style="font-size: 12px;">
            ...
            <div class="card-body" style="margin-left: -3px;">
                <table>
                    <tr>
                        ...
                        ?>
                        <td style="font-size: 13px;"><?php echo ($row_isiSurat->spp); ?><?php setlocale(LC_ALL, 'IND');
                                                                                        echo strftime('%d', strtotime($row_isiSurat->tgl_spp)); ?>/<?php echo $bln; ?>/<?php setlocale(LC_ALL, 'IND');
                ...
                <table>
                    <tr>
                        <td style="text-align: justify;">Dengan hormat, <br>
                            Bersama Surat ini kami mengajukan permohonan pembayaran, Sehubungan dengan telah terlaksananya pekerjaan <?php echo $row_isiSurat->nama_paket_pekerjaan; ?> pada <?php echo $row_isiSurat->instansi; ?> - <?php echo $row_isiSurat->satuan_kerja; ?> - <?php echo $row_isiSurat->nama_kabupaten; ?> - <?php echo $row_isiSurat->nama_provinsi; ?>, Tahun Anggaran <?php echo $row_isiSurat->tahun_anggaran; ?>, yang telah dilaksanankan sesuai dengan :
                        </td>
                    </tr>
        ...
        <div class="pagesetup">
            ...
            <div style="width: 100%; margin-left: 0px;">
                <table style="width: 100%; margin-left: -3px;">
                    <tr>
                        <td style="text-align: justify;">Pada kegiatan pekerjaan <?php echo $row_isiSurat->nama_paket_pekerjaan; ?> menggunakan proses belanja dengan metode pembelian E-Catalogue/ EPURCHASING <i style="color: blue;">(https://e-katalog.lkpp.go.id/)</i>, dengan ID Paket : <?php echo $row_isiSurat->id_paket; ?>, tanggal paket dibuat : <?php setlocale(LC_ALL, 'IND');
    ...
    <div id="element" style="font-size: 12px; margin-left: -17px;">
        <div style="background-color: #DCE6F1; border: 3px solid #145FA4;">
            ...
            <div class="container">
                ...
                <div class="bottom-right" style="right: 33px;"><b><?php echo $row_isiSurat->qrgen; ?></b></div>
            </div>
                ...
                <div class="card-body">
                    <table class="center" border="0" style="margin-left: 270px;">
                        ...
                        <tr>
                            ...
                            ?>
                            <td style="font-size: 12;"><?php echo ($row_isiSurat->inv); ?><?php setlocale(LC_ALL, 'IND');
                                                                                            echo strftime('%d', strtotime($row_isiSurat->tgl_inv)); ?>/<?php echo $bln; ?>/<?php setlocale(LC_ALL, 'IND');
                    ...
                    <table id="invoice" style="width: 100%;">
                        <tr>
                            ...
                            <td rowspan="3" style="text-align: left; width: 36%;"><?php echo $row_isiSurat->instansi; ?> - <?php echo $row_isiSurat->satuan_kerja; ?> - <?php echo $row_isiSurat->nama_kabupaten; ?> - <?php echo $row_isiSurat->nama_provinsi; ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td rowspan="3" style="text-align: left; width: 1%;" style="border-right:1px dotted black;"></td>
                            <td rowspan="3" style="text-align: left; width: 36%;"><?php echo $row_isiSurat->alamat_satuan_kerja; ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="col-md-1" style="text-align: right; width: 13%;"><b>Phone</b></td>
                            <td style="text-align: left; width: 1%;" style="border-right:1px dotted black;"></td>
                            <td style="text-align: left; width: 36%;"><?php echo $row_isiSurat->no_tlp_ppk; ?></td>
                        </tr>
                        <tr>
                            <td class="col-md-1" style="text-align: right; width: 13%;"></td>
                            <td style="text-align: left; width: 1%;"></td>
                            ...
                            <td class="col-md-1" style="text-align: right; width: 13%;"><b>Email</b></td>
                            <td style="text-align: left; width: 1%;" style="border-right:1px dotted black;"></td>
                            <td style="text-align: left; width: 36%;" style="color: blue;"><?php echo $row_isiSurat->email_ppk; ?></td>
                        </tr>
                        <tr>
                            <td class="col-md-1" style="text-align: right; width: 13%;"></td>
                            <td style="text-align: left; width: 1%;"></td>
                            ...
                            <td style="text-align: left; width: 1%;" style="border-right:1px dotted black;"></td>
                            <td style="text-align: left; width: 36%;">No SP/SPK : <?php echo $row_isiSurat->no_spk; ?>, tanggal : <?php setlocale(LC_ALL, 'IND');
                                                                                                                                    echo strftime('%d %B %Y', strtotime($row_isiSurat->tanggal_mulai_spk)); ?>,<br>ID Paket E-Catalogue : <?php echo $row_isiSurat->id_paket; ?>, tanggal : <?php setlocale(LC_ALL, 'IND');
                                                                                                                                                                                                                                                                                            echo strftime('%d %B %Y', strtotime($row_isiSurat->tanggal_paket_dibuat)); ?></td>
                        </tr>
                        <tr>
                            <td class="col-md-1" style="text-align: right; width: 13%;"></td>
                    ...
                    <table id="invoicetab" style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: middle; text-align: right; width: 13%;">&nbsp;<?php echo number_format(ltrim($row_isiSurat->harga_1 / 111 * 100, '0'), 0, '', '.') ?></td>
                            <td style="vertical-align: middle; text-align: right; width: 15%;">&nbsp;<?php echo number_format(ltrim($row_isiSurat->harga_1 / 111 * 100 * $row_isiSurat->jumlah_1, '0'), 0, '', '.') ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;">&nbsp;<?php echo number_format(ltrim($row_isiSurat->total_all / 111 * 100, '0'), 0, '', '.') ?></td>
                        </tr>
                        <tr>
                            <td colspan="5" style="text-align: right;"><b>Tax/PPN 11%</b></td>
                            <td style="text-align: right;">&nbsp;<?php echo number_format(ltrim($row_isiSurat->total_all - ($row_isiSurat->total_all / 111 * 100), '0'), 0, '', '.') ?></td>
                        </tr>
                        <tr>
                ...
                <div class="card-body">
                    <table class="center" border="0" style="margin-left: 270px;">
                        ...
                        <tr>
                            ...
                            ?>
                            <td style="font-size: 12;"><?php echo ($row_isiSurat->kwn); ?><?php setlocale(LC_ALL, 'IND');
                                                                                            echo strftime('%d', strtotime($row_isiSurat->tgl_kwn)); ?>/<?php echo $bln; ?>/<?php setlocale(LC_ALL, 'IND');
                    ...
                    <table id="invoice" style="width: 100%;">
                        <tr>
                            ...
                            <td style="text-align: left; width: 1%;" style="border-right:1px dotted black;"></td>
                            <td style="text-align: left; width: 83%;"><?php echo ($row_isiSurat->instansi); ?> - <?php echo ($row_isiSurat->satuan_kerja); ?> - <?php echo ($row_isiSurat->nama_kabupaten); ?> - <?php echo ($row_isiSurat->nama_provinsi); ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; width: 83%;">
                                <?php echo $row_isiSurat->nama_paket_pekerjaan; ?>,
                                <br>
                                No SP/SPK : <?php echo $row_isiSurat->no_spk; ?>, tanggal : <?php setlocale(LC_ALL, 'IND');
                                                                                            echo strftime('%d %B %Y', strtotime($row_isiSurat->tanggal_mulai_spk)); ?>,
                                <br>
                                ID Paket E-Catalogue : <?php echo $row_isiSurat->id_paket; ?>, tanggal : <?php setlocale(LC_ALL, 'IND');
                                                                                                            echo strftime('%d %B %Y', strtotime($row_isiSurat->tanggal_paket_dibuat)); ?>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <table id="invoicetab" style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: middle; text-align: center; width: 7%;"><?php echo $row_isiSurat->jumlah_1; ?></td>
                            <td style="vertical-align: middle; text-align: center; width: 7%;"><?php echo $row_isiSurat->satuan_1; ?></td>
                            <td style="vertical-align: middle; text-align: right; width: 13%;">&nbsp;<?php echo number_format(ltrim($row_isiSurat->harga_1, '0'), 0, '', '.') ?></td>
                            <td style="vertical-align: middle; text-align: right; width: 15%;">&nbsp;<?php echo number_format(ltrim($row_isiSurat->total_harga_1, '0'), 0, '', '.') ?></td>
                        </tr>
                        <tr>
                            <td class="col-md-1" style="vertical-align: middle; text-align: center; width: 5%;"><?php echo $row_isiSurat->no_2; ?></td>
                            <td style="vertical-align: middle; text-align: left; width: 53%;"><?php echo $row_isiSurat->nama_barang_2; ?></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: right; background-color: #DCE6F1;"><b>&nbsp;<?php echo number_format(ltrim($row_isiSurat->total_all, '0'), 0, '', '.') ?></b></td>
                        </tr>
                    </table>
                </div>
            </div>
            <div class="pagesetup" style="background-color: white;">
                ...
                <table id="invoice" style="width: 100%;">
                    <tr>
                        <td class="col-md-1" style="text-align: left; width: 20%;"></td>
                        <td class="col-md-1" style="text-align: left; width: 30%;"></td>
                        <td rowspan="5" class="col-md-1" style="text-align: center; width: 50%;"><strong><u><?php echo $row_ttd->nama; ?></u></strong><br><?php $row_ttd->jabatan;
                                                                                                                                                            echo ucfirst(strtolower($row_ttd->jabatan)); ?></td>
                    </tr>
                </table>
                <br>
