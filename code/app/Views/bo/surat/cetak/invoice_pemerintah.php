    ...
    <div id="element" style="font-size: 12px; margin-left: -17px;">
        ...
        <div style="background-color: #DCE6F1; border: 3px solid #145FA4;">
            ...
            <div class="container">
                ...
                <div class="top-left"><img class="qrgen" style="margin-left: 665px; margin-top: -96px;" height="51" src="<?php echo WRITEPATH . 'files/qrcode/qrcode-' . $row_isiSurat->qrgen . '.png' ?>"></div>
                ...
                <div class="card-body">
                    ...
                    <table id="invoice" style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; width: 1%;" style="border-right:1px dotted black;"></td>
                            <td style="text-align: left; width: 35%;"><b>1710016813191</b></td>
                            <td class="col-md-1" style="text-align: right; width: 13%;"><b>Phone</b></td>
                            <td style="text-align: left; width: 1%;" style="border-right:1px dotted black;"></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; width: 1%;" style="border-right:1px dotted black;"></td>
                            <td style="text-align: left; width: 35%;"><b>AMINS PROJECT TEKNOLOGI INDONESIA</b></td>
                            <td class="col-md-1" style="text-align: right; width: 13%;"><b>Email</b></td>
                            <td style="text-align: left; width: 1%;" style="border-right:1px dotted black;"></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; width: 1%;" style="border-right:1px dotted black;"></td>
                            <td style="text-align: left; width: 35%;"><b>0051048156<br>AMINS PROJECT CV<br></b></td>
                    ...
                    <br>
                    <table id="invoicetab" style="width: 100%; font-size: 12px;">
                        <tr>
                            <th style="vertical-align: middle; text-align: center; width: 5%;"><b>No</b></th>
                            <th style="vertical-align: middle; text-align: center; width: 53%;"><b>Nama Barang / Jasa</b></th>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: middle; text-align: right; width: 13%;">&nbsp;<?php echo number_format((int)ltrim((int)$row_isiSurat->harga_8, '0'), 0, '', '.') ?></td>
                            <td style="vertical-align: middle; text-align: right; width: 15%;">&nbsp;<?php echo number_format((int)ltrim((int)$row_isiSurat->total_harga_8, '0'), 0, '', '.') ?></td>
                        </tr>
                        <tr>
                            ...
                            <td style="vertical-align: middle; text-align: right; width: 13%;">&nbsp;<?php echo number_format((int)ltrim((int)$row_isiSurat->harga_9, '0'), 0, '', '.') ?></td>
                            <td style="vertical-align: middle; text-align: right; width: 15%;">&nbsp;<?php echo number_format((int)ltrim((int)$row_isiSurat->total_harga_9, '0'), 0, '', '.') ?></td>
                        </tr>
                        <tr>
                            ...
                            <td style="vertical-align: middle; text-align: right; width: 13%;">&nbsp;<?php echo number_format((int)ltrim((int)$row_isiSurat->harga_10, '0'), 0, '', '.') ?></td>
                            <td style="vertical-align: middle; text-align: right; width: 15%;">&nbsp;<?php echo number_format((int)ltrim((int)$row_isiSurat->total_harga_10, '0'), 0, '', '.') ?></td>
                        </tr>
                        <tr>
                            <td colspan="5" style="text-align: right;"><b>Sub Total</b></td>
                            <td style="text-align: right;"><b>&nbsp;<?php echo number_format((int)ltrim((int)$row_isiSurat->total_sementara, '0'), 0, '', '.') ?></b></td>
                        </tr>
                        <tr>
                            <td colspan="5" style="text-align: right;"><b>Diskon (<?php echo $row_isiSurat->persen_diskon; ?>%)</b></td>
                            <td style="text-align: right;"><b>&nbsp;<?php echo number_format((int)ltrim((int)$row_isiSurat->diskon, '0'), 0, '', '.') ?></b></td>
                        </tr>
                        <tr>
                            <td colspan="5" style="text-align: right;"><b>Uang Muka (<?php echo $row_isiSurat->persen_uang_muka; ?>%)</b></td>
                            <td style="text-align: right;"><b>&nbsp;<?php echo number_format((int)ltrim((int)$row_isiSurat->uang_muka, '0'), 0, '', '.') ?></b></td>
                        </tr>
                        <tr>
                            <td colspan="5" style="text-align: right;"><b>Sisa Pelunasan</b></td>
                            <td style="text-align: right;"><b>&nbsp;<?php echo number_format((int)ltrim((int)$row_isiSurat->total_all, '0'), 0, '', '.') ?></b></td>
                        </tr>
                        <tr>
            ...
            <div class="pagesetup" style="background-color: white;">
                ...
                <table id="invoice" style="width: 100%;">
                    <tr>
                        ...
                        <td rowspan="2" class="col-md-1" style="text-align: center; width: 50%;">Madiun, <?php setlocale(LC_ALL, 'id_ID.UTF-8', 'id_ID', 'indonesian');
                ...
                <table id="invoicetab1" style="width: 100%;">
                    <tr>
                        ...
                        <td style="vertical-align: middle; text-align: center; width: 34%;"><br>
                            ...
                            <b><u>(..............................................)</u></b><br>Penerima Barang / Jasa
                        </td>
                    </tr>
                </table>
                <br>
    ...
    <div id="element" style="font-size: 12px; margin-left: -17px;">
        <div style="background-color: #DCE6F1; border: 3px solid #145FA4;">
            ...
            <div class="pagesetup" style="background-color: white;">
                <br>
                <div class="card-body">
                    <table class="center" border="0" style="margin-left: 330px;">
                        <tr>
                    ...
                    <table id="invoice" style="width: 100%;">
                        <tr>
                            ...
                            <td style="text-align: left; width: 1%;" style="border-right:1px dotted black;"></td>
                            <td style="text-align: left; width: 83%;"><?php echo (isset($row_isiSurat->satuan_kerja) ? $row_isiSurat->satuan_kerja : ''); ?> - <?php echo (isset($row_isiSurat->nama_instansi) ? $row_isiSurat->nama_instansi : ''); ?> - <?php echo (isset($row_isiSurat->nama_kabupaten) ? $row_isiSurat->nama_kabupaten : ''); ?> - <?php echo (isset($row_isiSurat->nama_provinsi) ? $row_isiSurat->nama_provinsi : ''); ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; width: 83%;">
                                No Surat Pesanan : <?php echo (isset($row_isiSurat->no_surat_pemesanan) ? $row_isiSurat->no_surat_pemesanan : ''); ?>,
                                <br>
                                Tanggal Surat Pesanan : <?php setlocale(LC_ALL, 'IND');
                                                        echo strftime('%d %B %Y', strtotime(isset($row_isiSurat->tgl_surat_pemesanan) ? $row_isiSurat->tgl_surat_pemesanan : '')); ?>
                            </td>
                        </tr>
                        <tr>
                            <td class="col-md-1" style="text-align: right; width: 16%;"><b>NPWP</b></td>
                            <td style="text-align: left; width: 1%;" style="border-right:1px dotted black;"></td>
                            <td style="text-align: left; width: 83%;"><?php echo isset($row_isiSurat->npwp_satuan_kerja) ? $row_isiSurat->npwp_satuan_kerja : ''; ?></td>
                        </tr>
                    ...
                    <table id="invoicetab" style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: right; background-color: #DCE6F1;"><b>&nbsp;<?php echo number_format((int)ltrim((int)(isset($row_isiSurat->total_harga_ongkir) ? $row_isiSurat->total_harga_ongkir : 0), '0'), 0, '', '.') ?></b></td>
                        </tr>
                        <tr>
                            <td colspan="5" style="text-align: right; background-color: #DCE6F1;"><b>Total Sudah Termasuk PPN 11%</b></td>
                            <td style="text-align: right; background-color: #DCE6F1;"><b>&nbsp;<?php echo number_format((int)ltrim((int)$row_isiSurat->total_all, '0'), 0, '', '.') ?></b></td>
                        </tr>
                    </table>
                </div>
            </div>
                ...
                <table id="invoice" style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td rowspan="5" class="col-md-1" style="text-align: center; width: 50%;">Madiun, <?php setlocale(LC_ALL, 'IND');
                                                                                                            echo strftime('%d %B %Y', strtotime((isset($row_isiSurat->tgl_kwn)) ? $row_isiSurat->tgl_kwn : '')); ?><br><?php echo $model->getSetting(9)->content; ?></td>
                    </tr>
                    <tr>
