    ...
    <div class="pagesetup">
        ...
        <div style="width: 90%; margin-left: 0px;">
            ...
            <table style="width: 90%; margin-left: -3px;">
                ...
                <tr>
                    <td>Bersama surat ini, kami mohon agar diterbitkan Surat Dukungan / Referensi <?php echo $row_isiSurat->nama_bank; ?> atas nama :</td>
                </tr>
            ...
            <table style="width: 65%; margin-left: 70px;">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td style="width: 100%; text-align: justify;"><?php echo $row_isiSurat->nama_pekerjaan; ?> </td>
                    </tr>

                    <tr>
                        <td>Lokasi Pekerjaan</td>
                        <td>:</td>
                        <td style="width: 100%; text-align: justify;"><?php echo $row_isiSurat->lokasi_pekerjaan; ?> </td>
                    </tr>
                </tbody>
            </table>
            <br>
