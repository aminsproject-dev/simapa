                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-lg-6 mb-2">
                                    <label class="col-form-label">Nomor Surat INVPL<span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-lg-12 mb-2">
                                    ...
                                    <span class="text-red"><i>*</i></span><i>)Wajib isi. Nomor Kontrak / SP / SPK / SPMK</i></span>
                                    <input type="text" name="noted" class="form-control" placeholder="Masukan Noted" value="- TREM OF PAYMEN : INV ADVANCE 100% <br>-" required>
                                </div>
                                ...
                                <table class="col-lg-12">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="4"><input style="text-align: right;" type="text" value='' id="total_sementara" class="form-control" name="total_sementara" onchange="tryNumberFormat(this.form.thirdBox);" readonly></td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 mb-2">
                                            <label class="col-form-label">Email<span class="text-danger">*</span></label>
                                            <input type="text" name="email" value="<?= $row_isiSurat->email; ?>" class="form-control" placeholder="Masukan email" required>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-2">
                                            <label class="col-form-label">Noted<span class="text-danger">*</span></label>
                                            <span class="text-red"><i>*</i></span><i>)Wajib isi. Nomor Kontrak / SP / SPK / SPMK</i></span>
                                            <input type="text" name="noted" class="form-control" placeholder="Masukan Noted" value="<?= $row_isiSurat->noted; ?>" required>
                                        </div>
                                    ...
                                    <div class="row">
                                        <table class="col-lg-12">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th colspan="3" style="text-align: right;">Sub Total</th>
                                                    <td colspan="4"><input style="text-align: right;" type="text" value="<?= $row_isiSurat->total_sementara; ?>" id="total_sementara" class="form-control" name="total_sementara" onchange="tryNumberFormat(this.form.thirdBox);" readonly></td>
                                                </tr>
                                                <tr>
                                                    <th colspan="4"><input style="text-align: center;" type="text" id="no_diskon" class="form-control" placeholder="No Diskon" name="no_diskon" readonly value="Diskon"></th>
                                                    <td><input style="text-align: right;" type="text" id="persen_diskon" class="form-control" name="persen_diskon" value="<?= $row_isiSurat->persen_diskon; ?>" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                    <td><input style="text-align: right;" type="text" id="diskon" class="form-control" name="diskon" value="<?= $row_isiSurat->diskon; ?>" onchange="tryNumberFormat(this.form.thirdBox);" readonly> </td>
                                                </tr>
                                                <tr>
                                                    <th colspan="4"><input style="text-align: center;" type="text" id="no_uang_muka" class="form-control" placeholder="No Uang Muka" name="no_uang_muka" readonly value="Uang Muka"></th>
                                                    <td><input style="text-align: right;" type="text" id="persen_uang_muka" class="form-control" name="persen_uang_muka" value="<?= $row_isiSurat->persen_uang_muka; ?>" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                    <td><input style="text-align: right;" type="text" id="uang_muka" class="form-control" name="uang_muka" value="<?= $row_isiSurat->uang_muka; ?>" onchange="tryNumberFormat(this.form.thirdBox);" readonly> </td>
                                                </tr>
                                                <tr>
                                                    <th colspan="3" style="text-align: right;">Total Bayar</th>
