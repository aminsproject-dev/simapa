        ...
        <div class="modal-content">
            ...
            <form action="<?= site_url('surat/menuSurat?page=' . $page . '&jns=' . encrypt_data($jns) . '&action=' . encrypt_data('add')); ?>" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        <label class="col-lg-2 col-form-label text-lg-end">Jumlah Cek<span class="text-danger">*</span></label>
                        <div class="col-lg-10">
                            <input type="number" name="jumlah_cek" class="form-control" placeholder="Masukan Jumlah Cek" required>
                        </div>
                    </div>
                    ...
                    <form action="<?= site_url('surat/menuSurat?page=' . $page . '&jns=' . encrypt_data($jns) . '&action=' . encrypt_data('edit')); ?>" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                <label class="col-lg-2 col-form-label text-lg-end">Jumlah Cek<span class="text-danger">*</span></label>
                                <div class="col-lg-10">
                                    <input type="number" name="jumlah_cek" value="<?= $row_isiSurat->jumlah_cek; ?>" class="form-control" placeholder="Masukan Jumlah Cek" required>
                                </div>
                            </div>
