                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?= $row_isiSurat->mulai_cetak; ?></td>
                                            <td><?= $row_isiSurat->akhir_cetak; ?></td>
...
<div id="modal_tambah" class="modal fade" data-bs-backdrop="static" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= site_url('surat/menu-surat?page=' . $page . '&jns=' . encrypt_data($jns) . '&action=' . encrypt_data('add')); ?>" method="post">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        <label class="col-lg-2 col-form-label text-lg-end">Alamat Bank<span class="text-danger">*</span></label>
                        <div class="col-lg-10">
                            <textarea name="alamat_bank" id="alamat_bank" class="form-control ckeditor_classic" rows="4" cols="4"></textarea>
                        </div>
                    </div>

                    <div class="row mb-3">
                        <label class="col-lg-2 col-form-label text-lg-end">Nama Rekening Pemohon<span class="text-danger">*</span></label>
                        <div class="col-lg-10">
                    ...
                    <div class="row mb-3">
                        <label class="col-lg-2 col-form-label text-lg-end">Nomor Rekening Pemohon<span class="text-danger">*</span></label>
                        <div class="col-lg-10">
                            <input type="text" name="nomor_rekening" class="form-control" placeholder="Masukan Nomor Rekening" required>
                        </div>
                    </div>

                    <div class="row mb-3">
                        <label class="col-lg-2 col-form-label text-lg-end">Mulai Cetak<span class="text-danger">*</span></label>
                        <div class="col-lg-10">
                            <input type="text" name="mulai_cetak" class="form-control daterange-single" placeholder="Mulai Cetak" required>
                        </div>
                    </div>

                    <div class="row mb-3">
                        <label class="col-lg-2 col-form-label text-lg-end">Akhir Cetak<span class="text-danger">*</span></label>
                        <div class="col-lg-10">
                            <input type="text" name="akhir_cetak" class="form-control daterange-single" placeholder="Akhir Cetak" required>
                        </div>
                    </div>

                    <div class="row mb-3">
                        <label class="col-lg-2 col-form-label text-lg-end">Noted</label>
                        <div class="col-lg-10">
...
?>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <embed src='<?= site_url('surat/menu-surat?page=' . $page . '&jns=' . encrypt_data($jns) . '&action=' . encrypt_data('cetakSurat') . '&idx=' . $row['id_surat']); ?>' width='100%' height='600px'></embed>
                            </div>
                        </div>
        ...
        <div id="modal_cetakAmplop_<?= $row['id_surat']; ?>" data-bs-backdrop="static" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Cetak Amplop</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <embed src='<?= site_url('surat/menu-surat?page=' . $page . '&jns=' . encrypt_data($jns) . '&action=' . encrypt_data('cetakAmplop') . '&idx=' . $row['id_surat']); ?>' width='100%' height='600px'></embed>
                            </div>
                        </div>
        ...
        <div id="modal_uploadScan_<?= $row['id_surat']; ?>" data-bs-backdrop="static" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="<?= site_url('surat/menu-surat?page=' . $page . '&jns=' . encrypt_data($jns) . '&action=' . encrypt_data('uploadScan')); ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                    ...
                    <form action="<?= site_url('surat/menuSurat?page=' . $page . '&jns=' . encrypt_data($jns) . '&action=' . encrypt_data('edit')); ?>" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                <label class="col-lg-2 col-form-label text-lg-end">Alamat Bank<span class="text-danger">*</span></label>
                                <div class="col-lg-10">
                                    <textarea name="alamat_bank" id="alamat_bank" class="form-control ckeditor_classic" rows="4" cols="4"><?= $row_isiSurat->alamat_bank; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <label class="col-lg-2 col-form-label text-lg-end">Nomor Rekening Pemohon<span class="text-danger">*</span></label>
                                <div class="col-lg-10">
                                    <input type="text" name="nomor_rekening" value="<?= $row_isiSurat->nomor_rekening; ?>" class="form-control" placeholder="Masukan Nomor Rekening" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <label class="col-lg-2 col-form-label text-lg-end">Mulai Cetak<span class="text-danger">*</span></label>
                                <div class="col-lg-10">
                                    <input type="text" name="mulai_cetak" value="<?= $row_isiSurat->mulai_cetak; ?>" class="form-control daterange-single" placeholder="Mulai Cetak" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <label class="col-lg-2 col-form-label text-lg-end">Akhir Cetak<span class="text-danger">*</span></label>
                                <div class="col-lg-10">
                                    <input type="text" name="akhir_cetak" value="<?= $row_isiSurat->akhir_cetak; ?>" class="form-control daterange-single" placeholder="Akhir Cetak" required>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control select-search" id="mengetahui" name="mengetahui" required>
                                        ...
                                        foreach ($dt_jabatan as $jabatan) { ?>
                                            <option value="<?= $jabatan['id_jabatan']; ?>" <?= $isiTtd->id_jabatan == $jabatan['id_jabatan'] ? 'selected' : ''; ?>><?= $jabatan['nama']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
