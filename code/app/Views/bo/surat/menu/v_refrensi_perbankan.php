                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?= $row_isiSurat->alamat_bank; ?></td>
        ...
        <div class="modal-content">
            ...
            <form action="<?= site_url('surat/menuSurat?page=' . $page . '&jns=' . base64_encode($jns) . '&action=' . base64_encode('add')); ?>" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        <label class="col-lg-2 col-form-label text-lg-end">Nama Pekerjaan<span class="text-danger">*</span></label>
                        <div class="col-lg-10">
                            <input type="text" name="nama_pekerjaan" class="form-control" placeholder="Masukan Nama Pekerjaan Lengkap" required>
                        </div>
                    </div>

                    <div class="row mb-3">
                        <label class="col-lg-2 col-form-label text-lg-end">Lokasi Pekerjaan<span class="text-danger">*</span></label>
                        <div class="col-lg-10">
                            <textarea name="lokasi_pekerjaan" id="lokasi_pekerjaan" class="form-control ckeditor_classic" rows="4" cols="4"></textarea>
                        </div>
                    </div>

                    <div class="row mb-3">
                        <label class="col-lg-2 col-form-label text-lg-end">Noted<span class="text-danger">*</span></label>
                        <div class="col-lg-10">
                    ...
                    <form action="<?= site_url('surat/menuSurat?page=' . $page . '&jns=' . base64_encode($jns) . '&action=' . base64_encode('edit')); ?>" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                <label class="col-lg-2 col-form-label text-lg-end">Nama Pekerjaan<span class="text-danger">*</span></label>
                                <div class="col-lg-10">
                                    <input type="text" name="nama_pekerjaan" value="<?= $row_isiSurat->nama_pekerjaan; ?>" class="form-control" placeholder="Masukan Nama Pekerjaan Lengkap" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <label class="col-lg-2 col-form-label text-lg-end">Lokasi Pekerjaan<span class="text-danger">*</span></label>
                                <div class="col-lg-10">
                                    <textarea name="lokasi_pekerjaan" id="lokasi_pekerjaan" class="form-control ckeditor_classic" rows="4" cols="4"><?= $row_isiSurat->lokasi_pekerjaan; ?></textarea>
                                </div>
                            </div>
