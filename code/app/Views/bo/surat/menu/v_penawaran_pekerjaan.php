                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?= $row_isiSurat->nama_pekerjaan; ?></td>
        ...
        <div class="modal-content">
            ...
            <form action="<?= site_url('surat/menuSurat?page=' . $page . '&jns=' . base64_encode($jns) . '&action=' . base64_encode('add')); ?>" method="post" name="autoSumForm">
                ...
                <div class="modal-body">
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-lg-4 mb-2">
                                    <label class="col-form-label">Nomor Surat SPP<span class="text-danger">*</span></label>
                                    <input type="text" name="nomor_surat" value="<?= $nomor_surat; ?>" class="form-control" placeholder="Autogenerate" required readonly>
                                </div>
                                <div class="col-lg-4 mb-2">
                                    <label class="col-form-label">Nomor Surat SRPHP<span class="text-danger">*</span></label>
                                    <input type="text" name="srphp" value="<?= $srphp; ?>" class="form-control" placeholder="Autogenerate" required readonly>
                                </div>
                                <div class="col-lg-4 mb-2">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="text" id="nama_client" class="form-control" name="nama_client" required placeholder="Masukan Nama Client" />
                                    </div>
                                    <div class="mb-2">
                                        <label class="col-form-label">Tahun Anggaran<span class="text-danger">*</span></label>
                                        <input type="text" id="tahun_anggaran" class="form-control" name="tahun_anggaran" required placeholder="Masukan Tahun Anggaran" />
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="text" id="kota_client" class="form-control" name="kota_client" required placeholder="Masukan Kota Client" />
                                    </div>
                                    <div class="mb-2">
                                        <label class="col-form-label">Lama Pekerjaan Hari<span class="text-danger">*</span></label>
                                        <input type="text" id="hari_pekerjaan" class="form-control" name="hari_pekerjaan" required placeholder="Masukan Hari Pekerjaan" />
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-2">
                                        <label class="col-form-label">Nama Pekerjaan<span class="text-danger">*</span></label>
                                        <input type="text" id="nama_pekerjaan" class="form-control" name="nama_pekerjaan" required placeholder="Masukan Nama Pekerjaan" />
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="mb-2">
                                        ...
                                        <table>
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align: center;" width="120px">HPP</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><input type="text" id="hpp1" readonly class="form-control" name="hpp1" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                    <td><input type="text" id="harga_1" class="form-control" name="harga_1" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                    <td><input type="text" value='' id="total_harga_1" class="form-control" name="total_harga_1" onchange="tryNumberFormat(this.form.thirdBox);" readonly></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="text" id="hpp2" readonly class="form-control" name="hpp2" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                    <td><input type="text" id="harga_2" class="form-control" name="harga_2" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                    <td><input type="text" value='' id="total_harga_2" class="form-control" name="total_harga_2" onchange="tryNumberFormat(this.form.thirdBox);" readonly></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="text" id="hpp3" readonly class="form-control" name="hpp3" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                    <td><input type="text" id="harga_3" class="form-control" name="harga_3" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                    <td><input type="text" value='' id="total_harga_3" class="form-control" name="total_harga_3" onchange="tryNumberFormat(this.form.thirdBox);" readonly></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="text" id="hpp4" readonly class="form-control" name="hpp4" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                    <td><input type="text" id="harga_4" class="form-control" name="harga_4" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                    <td><input type="text" value='' id="total_harga_4" class="form-control" name="total_harga_4" onchange="tryNumberFormat(this.form.thirdBox);" readonly></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="text" id="hpp5" readonly class="form-control" name="hpp5" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                    <td><input type="text" id="harga_5" class="form-control" name="harga_5" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                    <td><input type="text" value='' id="total_harga_5" class="form-control" name="total_harga_5" onchange="tryNumberFormat(this.form.thirdBox);" readonly></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="text" id="hpp6" readonly class="form-control" name="hpp6" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                    <td><input type="text" id="harga_6" class="form-control" name="harga_6" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                    <td><input type="text" value='' id="total_harga_6" class="form-control" name="total_harga_6" onchange="tryNumberFormat(this.form.thirdBox);" readonly></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="text" id="hpp7" readonly class="form-control" name="hpp7" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                    <td><input type="text" id="harga_7" class="form-control" name="harga_7" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                    <td><input type="text" value='' id="total_harga_7" class="form-control" name="total_harga_7" onchange="tryNumberFormat(this.form.thirdBox);" readonly></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="text" id="hpp8" readonly class="form-control" name="hpp8" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                    <td><input type="text" id="harga_8" class="form-control" name="harga_8" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                    <td><input type="text" value='' id="total_harga_8" class="form-control" name="total_harga_8" onchange="tryNumberFormat(this.form.thirdBox);" readonly></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="text" id="hpp9" readonly class="form-control" name="hpp9" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                    <td><input type="text" id="harga_9" class="form-control" name="harga_9" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                    <td><input type="text" value='' id="total_harga_9" class="form-control" name="total_harga_9" onchange="tryNumberFormat(this.form.thirdBox);" readonly></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="text" id="hpp10" readonly class="form-control" name="hpp10" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                    <td><input type="text" id="harga_10" class="form-control" name="harga_10" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                    <td><input type="text" value='' id="total_harga_10" class="form-control" name="total_harga_10" onchange="tryNumberFormat(this.form.thirdBox);" readonly></td>
                                                </tr>
                                                <tr>
                    ...
                    <div class="text-muted"><span class="text-danger">*</span>) Wajib isi. Harga yang diinput harus sudah termasuk ppn dan pph</div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 mb-2">
                                            <label class="col-form-label">Nomor Surat SRPHP<span class="text-danger">*</span></label>
                                            <input type="text" name="srphp" value="<?= $row_isiSurat->srphp; ?>" class="form-control" placeholder="Autogenerate" required readonly>
                                        </div>
                                        <div class="col-lg-4 mb-2">
                                            <label class="col-form-label">Qrgen<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="mb-2">
                                                <label class="col-form-label">Nama Client<span class="text-danger">*</span></label>
                                                <input type="text" id="nama_client" class="form-control" name="nama_client" value="<?= $row_isiSurat->nama_client; ?>" required placeholder="Masukan Nama Client" />
                                            </div>
                                            <div class="mb-2">
                                                <label class="col-form-label">Tahun Anggaran<span class="text-danger">*</span></label>
                                                <input type="text" id="tahun_anggaran" class="form-control" name="tahun_anggaran" value="<?= $row_isiSurat->tahun_anggaran; ?>" required placeholder="Masukan Tahun Anggaran" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="mb-2">
                                                <label class="col-form-label">Kota Client<span class="text-danger">*</span></label>
                                                <input type="text" id="kota_client" value="<?= $row_isiSurat->kota_client; ?>" class="form-control" name="kota_client" required placeholder="Masukan Kota Client" />
                                            </div>
                                            <div class="mb-2">
                                                <label class="col-form-label">Lama Pekerjaan Hari<span class="text-danger">*</span></label>
                                                <input type="text" id="hari_pekerjaan" value="<?= $row_isiSurat->hari_pekerjaan; ?>" class="form-control" name="hari_pekerjaan" required placeholder="Masukan Hari Pekerjaan" />
                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-2">
                                                <label class="col-form-label">Nama Pekerjaan<span class="text-danger">*</span></label>
                                                <input type="text" id="nama_pekerjaan" value="<?= $row_isiSurat->nama_pekerjaan; ?>" class="form-control" name="nama_pekerjaan" required placeholder="Masukan Nama Pekerjaan" />
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="mb-2">
                                                ...
                                                <table>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><input type="text" id="hpp1" readonly class="form-control" name="hpp1" value="<?= $row_isiSurat->hpp1; ?>" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" id="hpp2" readonly class="form-control" name="hpp2" value="<?= $row_isiSurat->hpp2; ?>" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" id="hpp3" readonly class="form-control" name="hpp3" value="<?= $row_isiSurat->hpp3; ?>" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                            ...
                                                            <td><input type="text" id="total_harga_3" class="form-control" value="<?= $row_isiSurat->total_harga_3; ?>" name="total_harga_3" onchange="tryNumberFormat(this.form.thirdBox);" readonly></td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td><input type="text" id="hpp4" readonly class="form-control" name="hpp4" value="<?= $row_isiSurat->hpp4; ?>" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" id="hpp5" readonly class="form-control" name="hpp5" value="<?= $row_isiSurat->hpp5; ?>" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" id="hpp6" readonly class="form-control" name="hpp6" value="<?= $row_isiSurat->hpp6; ?>" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" id="hpp7" readonly class="form-control" name="hpp7" value="<?= $row_isiSurat->hpp7; ?>" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" id="hpp8" readonly class="form-control" name="hpp8" value="<?= $row_isiSurat->hpp8; ?>" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" id="hpp9" readonly class="form-control" name="hpp9" value="<?= $row_isiSurat->hpp9; ?>" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" id="hpp10" readonly class="form-control" name="hpp10" value="<?= $row_isiSurat->hpp10; ?>" onFocus="startCalc();" onBlur="stopCalc();" /></td>
                                                        ...
                                                        <tr>
                                                            <th colspan="3" style="text-align: right;">Total</th>
                                                            <td colspan="4"><input style="text-align: right;" type="text" value="<?= $row_isiSurat->total_all; ?>" id="total_all" class="form-control" name="total_all" onchange="tryNumberFormat(this.form.thirdBox);" readonly></td>
                                                        </tr>
...
<script>
    ...
    function calc() {
        ...
        document.autoSumForm.hpp1.value = (((jumlah_1 * 1) * (harga_1 * 1)) / 113 * 100).toFixed(2);
        ...
        document.autoSumForm.hpp2.value = (((jumlah_2 * 1) * (harga_2 * 1)) / 113 * 100).toFixed(2);
        ...
        document.autoSumForm.hpp3.value = (((jumlah_3 * 1) * (harga_3 * 1)) / 113 * 100).toFixed(2);
        ...
        document.autoSumForm.hpp4.value = (((jumlah_4 * 1) * (harga_4 * 1)) / 113 * 100).toFixed(2);
        ...
        document.autoSumForm.hpp5.value = (((jumlah_5 * 1) * (harga_5 * 1)) / 113 * 100).toFixed(2);
        ...
        document.autoSumForm.hpp6.value = (((jumlah_6 * 1) * (harga_6 * 1)) / 113 * 100).toFixed(2);
        ...
        document.autoSumForm.hpp7.value = (((jumlah_7 * 1) * (harga_7 * 1)) / 113 * 100).toFixed(2);
        ...
        document.autoSumForm.hpp8.value = (((jumlah_8 * 1) * (harga_8 * 1)) / 113 * 100).toFixed(2);
        ...
        document.autoSumForm.hpp9.value = (((jumlah_9 * 1) * (harga_9 * 1)) / 113 * 100).toFixed(2);
        ...
        document.autoSumForm.hpp10.value = (((jumlah_10 * 1) * (harga_10 * 1)) / 113 * 100).toFixed(2);
        document.autoSumForm.total_all.value = ((jumlah_1 * 1) * (harga_1 * 1)) + ((jumlah_2 * 1) * (harga_2 * 1)) + ((jumlah_3 * 1) * (harga_3 * 1)) + ((jumlah_4 * 1) * (harga_4 * 1)) + ((jumlah_5 * 1) * (harga_5 * 1)) + ((jumlah_6 * 1) * (harga_6 * 1)) + ((jumlah_7 * 1) * (harga_7 * 1)) + ((jumlah_8 * 1) * (harga_8 * 1)) + ((jumlah_9 * 1) * (harga_9 * 1)) + ((jumlah_10 * 1) * (harga_10 * 1));
    }
