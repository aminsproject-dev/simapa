        ...
        <div class="row">
            <div class="col-sm-12 col-xl-12">
                ...
                <div class="card">
                    ...
                    <form action="<?= base_url('pengalaman/add'); ?>" method="post">
                        <div class="card-body">

                            <div class="row mb-3">
                                <label class="col-lg-2 col-form-label text-lg-end">Nama Kontrak<span class="text-danger">*</span></label>
                                <div class="col-lg-10">
                                    <input type="text" name="nama_kontrak" value="<?= old('nama_kontrak'); ?>" class="form-control" placeholder="Masukkan nama kontrak" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" name="nomor_kontrak" value="<?= old('nomor_kontrak'); ?>" class="form-control" placeholder="Masukkan nomor kontrak" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-4">
                                    <input type="text" name="tanggal_mulai" value="<?= old('tanggal_mulai'); ?>" class="form-control daterange-single" placeholder="Masukkan tanggal mulai kontrak" required>
                                </div>
                                <label class="col-lg-2 col-form-label text-lg-end">Tanggal Selesai Kontrak<span class="text-danger">*</span></label>
                                <div class="col-lg-4">
                                    <input type="text" name="tanggal_selesai" value="<?= old('tanggal_selesai'); ?>" class="form-control daterange-single" placeholder="Masukkan tanggal selesai kontrak" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-4">
                                    <input type="text" name="tanggal_serah_terima" value="<?= old('tanggal_serah_terima'); ?>" class="form-control daterange-single" placeholder="Masukkan tanggal serah terima" required>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nilai_kontrak" value="<?= old('nilai_kontrak'); ?>" class="form-control" placeholder="Masukkan nilai kontrak (Rp)" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-4">
                                    <select name="id_kategori_pekerjaan" class="form-control select-search" required>
                                        ...
                                        <?php foreach ($dt_kategori as $kategori) { ?>
                                            <option value="<?= $kategori['id_kategori_pekerjaan']; ?>" <?= old('id_kategori_pekerjaan') == $kategori['id_kategori_pekerjaan'] ? 'selected' : ''; ?>><?= $kategori['nama_kategori_pekerjaan']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="input-group">
                                        <input type="number" name="persentase_pekerjaan" value="<?= old('persentase_pekerjaan'); ?>" class="form-control" placeholder="Masukkan presentase pekerjaan (%)" required>
                                        <div class="input-group-text">
                                            %
                                        </div>
                                    </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-4">
                                    <textarea name="uraian_pekerjaan" class="form-control ckeditor_classic"><?= old('uraian_pekerjaan'); ?></textarea>
                                </div>
                                <label class="col-lg-2 col-form-label text-lg-end">Ruang Lingkup Pekerjaan<span class="text-danger">*</span></label>
                                <div class="col-lg-4">
                                    <textarea name="ruang_lingkup_pekerjaan" class="form-control ckeditor_classic"><?= old('ruang_lingkup_pekerjaan'); ?></textarea>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-4">
                                    <select name="id_kbli" class="form-control select-search" required>
                                        ...
                                        <?php foreach ($dt_kbli as $kbli) { ?>
                                            <option value="<?= $kbli['id_kbli']; ?>" <?= old('id_kbli') == $kbli['id_kbli'] ? 'selected' : ''; ?>><?= $kbli['kode_kbli']; ?> - <?= $kbli['nama_kbli']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-4">
                                    <textarea name="alamat_pekerjaan" class="form-control ckeditor_classic"><?= old('alamat_pekerjaan'); ?></textarea>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <select name="id_negara_pekerjaan" class="form-control select-search" required>
                                        ...
                                        <?php foreach ($dt_country as $country) { ?>
                                            <option value="<?= $country['id_negara']; ?>" <?= old('id_negara_pekerjaan') == $country['id_negara'] ? 'selected' : ''; ?>><?= $country['nama_negara']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-4">
                                    <select name="id_provinsi_pekerjaan" id="id_provinsi_pekerjaan" class="form-control select-search" required>
                                        ...
                                        <?php foreach ($dt_province as $province) { ?>
                                            <option value="<?= $province['id']; ?>" <?= old('id_provinsi_pekerjaan') == $province['id'] ? 'selected' : ''; ?>><?= $province['nama_provinsi']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <select name="id_jenis_instansi" id="id_jenis_instansi" class="form-control select-search" required>
                                        ...
                                        <?php foreach ($dt_jenis_instansi as $jenis) { ?>
                                            <option value="<?= $jenis['id_jenis_instansi']; ?>" <?= old('id_jenis_instansi') == $jenis['id_jenis_instansi'] ? 'selected' : ''; ?>><?= $jenis['nama_jenis_instansi']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <select name="id_nama_instansi" id="id_nama_instansi" class="form-control select-search" required>
                                        ...
                                        <?php foreach ($dt_nama_instansi as $nama) { ?>
                                            <option value="<?= $nama['id_nama_instansi']; ?>" <?= old('id_nama_instansi') == $nama['id_nama_instansi'] ? 'selected' : ''; ?>><?= $nama['nama_instansi']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-4">
                                    <select name="id_satuan_kerja" id="id_satuan_kerja" class="form-control select-search" required>
                                        ...
                                        <?php foreach ($dt_satker as $satker) { ?>
                                            <option value="<?= $satker['id_satuan_kerja']; ?>" <?= old('id_satuan_kerja') == $satker['id_satuan_kerja'] ? 'selected' : ''; ?>><?= $satker['nama_satuan_kerja']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <select name="id_provinsi_instansi" id="id_provinsi_instansi" class="form-control select-search" required>
                                        ...
                                        <?php foreach ($dt_province as $province) { ?>
                                            <option value="<?= $province['id']; ?>" <?= old('id_provinsi_instansi') == $province['id'] ? 'selected' : ''; ?>><?= $province['nama_provinsi']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-4">
                                    <input type="number" name="telepon_instansi" value="<?= old('telepon_instansi'); ?>" class="form-control" placeholder="Masukkan nomor telepon instansi" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-10">
                                    <textarea name="alamat_instansi" class="form-control ckeditor_classic"><?= old('alamat_instansi'); ?></textarea>
                                </div>
                            </div>
...
<script>
    jQuery(function($) {
        getRegency("#id_provinsi_pekerjaan", "#id_kabupaten_pekerjaan")
        getRegency("#id_provinsi_instansi", "#id_kabupaten_instansi")
