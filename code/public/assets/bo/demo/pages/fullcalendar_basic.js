...
const FullCalendarBasic = (function () {
  ...
  const _componentFullCalendarBasic = function () {
    ...
    // Define element
    const calendarBasicViewElement = document.querySelector(
      ".fullcalendar-basic"
    );

    // Initialize
    if (calendarBasicViewElement) {
      const calendarBasicViewInit = new FullCalendar.Calendar(
      ...
      document
        .querySelectorAll(".sidebar-control")
    ...
    // Define element
    const calendarAgendaViewElement = document.querySelector(
      ".fullcalendar-agenda"
    );

    // Initialize
    if (calendarAgendaViewElement) {
      const calendarAgendaViewInit = new FullCalendar.Calendar(
    ...
    // Define element
    const calendarListViewElement =
      document.querySelector(".fullcalendar-list");

    // Initialize
    if (calendarListViewElement) {
      const calendarListViewInit = new FullCalendar.Calendar(
        calendarListViewElement,
        {
          headerToolbar: {
            left: "prev,next today",
            center: "title",
