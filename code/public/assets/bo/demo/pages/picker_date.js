...
var DateTimePickers = (function () {
  ...
  const _componentDaterange = function () {
    ...
    $(".daterange-single-searchChart").daterangepicker({
    ...
    $(document).ready(function () {
      $('input[name="tgl_awal_chart"]').daterangepicker(
        {
          singleDatePicker: true,
          locale: {
            format: "YYYY-MM-DD",
        ...
        function (start, end, label) {
          ...
          var endDate = moment(startDate).add(14, "days").format("YYYY-MM-DD");

          $('input[name="tgl_akhir_chart"]').val(endDate);

          $('input[name="tgl_akhir_chart"]').daterangepicker({
            singleDatePicker: true,
            startDate: endDate,
            locale: {
              format: "YYYY-MM-DD",
      ...
      // Initialize Date Range Picker for the end date (in case the user wants to change it)
    ...
    $(".daterange-single-choose").daterangepicker({
      parentEl: ".content-inner",
      singleDatePicker: true,
    ...
    // Event untuk memperbarui nilai input ketika tanggal dipilih
    $(".daterange-single-choose").on(
      "apply.daterangepicker",
      function (ev, picker) {
        $(this).val(picker.startDate.format("YYYY-MM-DD")); // Atur nilai input saat tanggal dipilih
      }
    );

    // Event untuk mengosongkan input ketika dibatalkan (jika ada tombol cancel)
    $(".daterange-single-choose").on(
    ...
    $(".daterange-time-custom").each(function () {
  ...
  const _componentDatepicker = function () {
    ...
    // Disabled weekdays
    const dpWeekdaysDisabledElement = document.querySelector(
      ".datepicker-weekdays-disabled"
    );
    ...
    // Disabled dates
    const dpDatesDisabledElement = document.querySelector(
    ...
    const dpDaysHighlightedElement = document.querySelector(
    ...
    // Date format
    const dpDateFormatElement = document.querySelector(
    ...
    // Multiple dates
    const dpDatesMultipleElement = document.querySelector(
      ".datepicker-multiple-dates"
    );
    ...
    const dpPickLevelElementYear = document.querySelector(".datepicker-year");
    if (dpPickLevelElementYear) {
      const dpPickLevelYear = new Datepicker(dpPickLevelElementYear, {
        container: ".content-inner",
        buttonClass: "btn",
        prevArrow: document.dir == "rtl" ? "&rarr;" : "&larr;",
        nextArrow: document.dir == "rtl" ? "&larr;" : "&rarr;",
    ...
    // Change default view
    const dpDefaultViewElement = document.querySelector(
      ".datepicker-default-view"
    );
    if (dpDefaultViewElement) {
      $("#modal_ekspor").on("shown.bs.modal", function () {
        const dpDefaultView = new Datepicker(dpDefaultViewElement, {
          ...
          prevArrow: document.dir == "rtl" ? "&rarr;" : "&larr;",
          nextArrow: document.dir == "rtl" ? "&larr;" : "&rarr;",
          startView: 2, // Set startView untuk hanya menampilkan tahun
          minViewMode: 2, // Set minViewMode untuk memilih tahun saja
          format: "yyyy",
        });
      });
    }
    ...
    // Today button
    const dpTodayButtonElement = document.querySelector(
    ...
    const dpOneSideElement = document.querySelector(
      ".datepicker-range-one-side"
    );
    if (dpOneSideElement) {
