...
--
-- Host: localhost
-- Waktu pembuatan: 13 Mar 2026 pada 14.41
...
--
-- Struktur dari tabel `tbl_mkabupaten`
--

CREATE TABLE `tbl_mkabupaten` (
  `id_kabupaten` int(10) UNSIGNED NOT NULL,
  `id_provinsi` varchar(2) NOT NULL DEFAULT '',
  `nama_kabupaten` varchar(30) NOT NULL,
  `pusat_pemerintah` varchar(40) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data untuk tabel `tbl_mkabupaten`
--

INSERT INTO `tbl_mkabupaten` (`id_kabupaten`, `id_provinsi`, `nama_kabupaten`, `pusat_pemerintah`) VALUES
...
--
-- Indeks untuk tabel `tbl_mkabupaten`
--
ALTER TABLE `tbl_mkabupaten`
...
--
-- AUTO_INCREMENT untuk tabel `tbl_mkabupaten`
--
ALTER TABLE `tbl_mkabupaten`
  MODIFY `id_kabupaten` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9476;
COMMIT;
