...
--
-- Struktur dari tabel `tbl_mkecamatan`
--

CREATE TABLE `tbl_mkecamatan` (
...
--
-- Dumping data untuk tabel `tbl_mkecamatan`
--

INSERT INTO `tbl_mkecamatan` (`id_kecamatan`, `id_kabupaten`, `nama_kecamatan`) VALUES
...
--
-- Indeks untuk tabel `tbl_mkecamatan`
--
ALTER TABLE `tbl_mkecamatan`
...
--
-- AUTO_INCREMENT untuk tabel `tbl_mkecamatan`
--
ALTER TABLE `tbl_mkecamatan`
  MODIFY `id_kecamatan` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9471042;
COMMIT;
